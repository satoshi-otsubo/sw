...
public class Global extends GlobalSettings {
    ...
    @Override
    public Promise<Result> onError(Http.RequestHeader requestHeader, Throwable throwable) {
    ...
    @Override
    public Promise<Result> onBadRequest(Http.RequestHeader requestHeader, String s) {
     ...
     */
    @Override
    public Promise<Result> onHandlerNotFound(Http.RequestHeader requestHeader) {
