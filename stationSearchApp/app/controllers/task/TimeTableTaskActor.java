...
public class TimeTableTaskActor extends UntypedActor{
	@Override
	public void onReceive(Object message) throws ParseException{
	...
	private void setTimeTable() {	
        System.out.println("===== 時刻表取得タスク Start =====");
        ...
        System.out.println("===== 時刻表取得タスク End =====");
